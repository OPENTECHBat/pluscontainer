...
import {useState, onWillStart, useExternalListener,useEffect,Component,useRef} from "@odoo/owl";
...
//core.action_registry.add('warehouse_operation', WarehouseOperationDisplay);
actionRegistry.add("warehouse_operation", WarehouseOperationDisplay);
actionRegistry.add('warehouse_picking', WarehousePickingDisplay);
