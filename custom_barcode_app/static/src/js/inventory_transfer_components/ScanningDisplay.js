...
//            immediate_transfer: true,
    ...
    getStockOperationTypeData = async (operation_type_id) => {
        let data =  await this.orm.call("stock.operation.data.prepare", "get_stock_operation_type_data",  [[], operation_type_id]);
...
//        });
    ...
    getScanData = async (barcode) => {
            let data =  await this.orm.call("stock.operation.data.prepare", "scan_get_data",  [[], barcode]);
...
actionRegistry.add('create_transfer', ScanningDisplay);